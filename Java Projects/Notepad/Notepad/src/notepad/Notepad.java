...
public class Notepad extends JFrame implements ActionListener {
    ...
    Notepad() {
        ...
        file.setFont(new Font("ARRIAL",Font.PLAIN, 14));
        ...
        edit.setFont(new Font("ARRIAL",Font.PLAIN, 14));
        ...
        helpmenu.setFont(new Font("ARRIAL",Font.PLAIN, 14));
